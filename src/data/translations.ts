...
export const translations: Record<string, Localized> = {
  ...
  'nav.market': { en: 'Agri Market', hi: 'कृषि बाज़ार', gu: 'કૃષિ બજાર' },
  'nav.community': { en: 'Community', hi: 'समुदाय', gu: 'સમુદાય' },

  'dashboard.features': { en: 'Discover Features', hi: 'सुविधाएँ खोजें', gu: 'સુવિધાઓ શોધો' },
  'dashboard.diseaseTitle': { en: 'Disease Tracker', hi: 'रोग ट्रैकर', gu: 'રોગ ટ્રેકર' },
  'dashboard.diseaseSubtitle': { en: 'Scan crops for diseases', hi: 'फसलों में रोग स्कैन करें', gu: 'પાકમાં રોગો સ્કેન કરો' },
  'dashboard.diseaseAction': { en: 'Scan Crop', hi: 'फसल स्कैन करें', gu: 'પાક સ્કેન કરો' },
  'dashboard.adviceTitle': { en: 'Crop Advice', hi: 'फसल सलाह', gu: 'પાકની સલાહ' },
  'dashboard.adviceSubtitle': { en: 'Get AI farming advice', hi: 'एआई कृषि सलाह प्राप्त करें', gu: 'AI ખેતીની સલાહ મેળવો' },
  'dashboard.adviceAction': { en: 'Ask AI', hi: 'एआई से पूछें', gu: 'AI ને પૂછો' },
  'dashboard.marketTitle': { en: 'Agri Market', hi: 'कृषि बाज़ार', gu: 'કૃષિ બજાર' },
  'dashboard.marketSubtitle': { en: 'Buy seeds, fertilizers & tools', hi: 'बीज, उर्वरक और उपकरण खरीदें', gu: 'બિયારણ, ખાતર અને સાધનો ખરીદો' },
  'dashboard.marketAction': { en: 'Shop Now', hi: 'अभी खरीदें', gu: 'હમણાં ખરીદી કરો' },
  'dashboard.schemesTitle': { en: 'Govt Schemes', hi: 'सरकारी योजनाएँ', gu: 'સરકારી યોજનાઓ' },
  'dashboard.schemesSubtitle': { en: 'Find eligible subsidies', hi: 'योग्य सब्सिडी खोजें', gu: 'લાયક સબસિડી શોધો' },
  'dashboard.schemesAction': { en: 'View Schemes', hi: 'योजनाएँ देखें', gu: 'યોજનાઓ જુઓ' },
  'dashboard.communityTitle': { en: 'Farmer Community', hi: 'किसान समुदाय', gu: 'ખેડૂત સમુદાય' },
  'dashboard.communitySubtitle': { en: 'Discuss with other farmers', hi: 'अन्य किसानों के साथ चर्चा करें', gu: 'અન્ય ખેડૂતો સાથે ચર્ચા કરો' },
  'dashboard.communityAction': { en: 'Join Discussion', hi: 'चर्चा में शामिल हों', gu: 'ચર્ચામાં જોડાઓ' },

  'agriMarket.title': { en: 'Agri Market', hi: 'कृषि बाज़ार', gu: 'કૃષિ બજાર' },
  'agriMarket.subtitle': { en: 'Buy seeds, fertilizers, and farming tools', hi: 'बीज, उर्वरक और खेती के उपकरण खरीदें', gu: 'બિયારણ, ખાતર અને ખેતીના સાધનો ખરીદો' },
  'agriMarket.search': { en: 'Search products...', hi: 'उत्पाद खोजें...', gu: 'ઉત્પાદનો શોધો...' },
  'agriMarket.allCategories': { en: 'All Categories', hi: 'सभी श्रेणियाँ', gu: 'બધી શ્રેણીઓ' },
  'agriMarket.demoNotice': { en: 'Demo: Purchases are not real.', hi: 'डेमो: खरीदारी वास्तविक नहीं है।', gu: 'ડેમો: ખરીદી વાસ્તવિક નથી.' },

  'community.title': { en: 'Farmer Community', hi: 'किसान समुदाय', gu: 'ખેડૂત સમુદાય' },
  'community.subtitle': { en: 'Ask questions and share knowledge', hi: 'प्रश्न पूछें और ज्ञान साझा करें', gu: 'પ્રશ્નો પૂછો અને જ્ઞાન વહેંચો' },
  'community.search': { en: 'Search discussions...', hi: 'चर्चा खोजें...', gu: 'ચર્ચાઓ શોધો...' },
  'community.askQuestion': { en: 'Ask a Question', hi: 'एक प्रश्न पूछें', gu: 'પ્રશ્ન પૂછો' },
  'community.answers': { en: 'Answers', hi: 'उत्तर', gu: 'જવાબો' },
  'community.beFirst': { en: 'Be the first to answer', hi: 'उत्तर देने वाले पहले व्यक्ति बनें', gu: 'જવાબ આપનાર પ્રથમ બનો' },
  'community.expertVerified': { en: 'Expert Verified', hi: 'विशेषज्ञ सत्यापित', gu: 'નિષ્ણાત દ્વારા ચકાસાયેલ' },

  'schemes.title': { en: 'Govt Schemes', hi: 'सरकारी योजनाएँ', gu: 'સરકારી યોજનાઓ' },
  'schemes.subtitle': { en: 'Subsidies and support for farmers', hi: 'किसानों के लिए सब्सिडी और समर्थन', gu: 'ખેડૂતો માટે સબસિડી અને ટેકો' },
  'schemes.officialSource': { en: 'Official Source', hi: 'आधिकारिक स्रोत', gu: 'સત્તાવાર સ્ત્રોત' },
  'schemes.visitPortal': { en: 'Visit Portal', hi: 'पोर्टल पर जाएँ', gu: 'પોર્ટલની મુલાકાત લો' },

  'diseaseTracker.title': { en: 'Disease Tracker', hi: 'रोग ट्रैकर', gu: 'રોગ ટ્રેકર' },
  'diseaseTracker.subtitle': { en: 'Upload a photo of your crop to identify diseases', hi: 'रोगों की पहचान करने के लिए अपनी फसल की एक तस्वीर अपलोड करें', gu: 'રોગો ઓળખવા માટે તમારા પાકનો ફોટો અપલોડ કરો' },
  'diseaseTracker.upload': { en: 'Upload Photo', hi: 'फोटो अपलोड करें', gu: 'ફોટો અપલોડ કરો' },
  'diseaseTracker.analyze': { en: 'Analyze Crop', hi: 'फसल का विश्लेषण करें', gu: 'પાકનું વિશ્લેષણ કરો' },
  'diseaseTracker.demoNotice': { en: 'Demo: Image analysis is simulated.', hi: 'डेमो: छवि विश्लेषण सिम्युलेटेड है।', gu: 'ડેમો: ઇમેજ વિશ્લેષણ સિમ્યુલેટેડ છે.' },
  'diseaseTracker.result': { en: 'Analysis Result', hi: 'विश्लेषण परिणाम', gu: 'વિશ્લેષણ પરિણામ' },

  'cropAdvice.title': { en: 'Crop Advice', hi: 'फसल सलाह', gu: 'પાકની સલાહ' },
  'cropAdvice.subtitle': { en: 'AI-powered farming recommendations', hi: 'एआई-संचालित कृषि सिफारिशें', gu: 'AI-સંચાલિત ખેતીની ભલામણો' },
  'cropAdvice.askPlaceholder': { en: 'Ask a farming question...', hi: 'खेती का कोई प्रश्न पूछें...', gu: 'ખેતીનો કોઈ પ્રશ્ન પૂછો...' },
  'cropAdvice.demoNotice': { en: 'Demo: AI responses are pre-generated.', hi: 'डेमो: एआई प्रतिक्रियाएँ पूर्व-निर्मित हैं।', gu: 'ડેમો: AI જવાબો અગાઉથી જનરેટ કરેલા છે.' },
  'cropAdvice.recommendation': { en: 'Recommendation', hi: 'सिफारिश', gu: 'ભલામણ' },
  'cropAdvice.actions': { en: 'Recommended Actions', hi: 'अनुशंसित कार्रवाइयां', gu: 'ભલામણ કરેલ ક્રિયાઓ' },
  'cropAdvice.cautions': { en: 'Cautions', hi: 'सावधानियां', gu: 'સાવચેતીઓ' },

  'farmProfile.title': { en: 'Farm Profile', hi: 'खेत प्रोफ़ाइल', gu: 'ખેતર પ્રોફાઇલ' },
  'farmProfile.subtitle': { en: 'Manage your farm details', hi: 'अपने खेत का विवरण प्रबंधित करें', gu: 'તમારા ખેતરની વિગતો મેનેજ કરો' },
  'farmProfile.soilType': { en: 'Soil Type', hi: 'मिट्टी का प्रकार', gu: 'માટીનો પ્રકાર' },
  'farmProfile.currentCrop': { en: 'Current Crop', hi: 'वर्तमान फसल', gu: 'વર્તમાન પાક' },
  'farmProfile.budget': { en: 'Budget', hi: 'बजट', gu: 'બજેટ' },
  'farmProfile.irrigation': { en: 'Irrigation Type', hi: 'सिंचाई का प्रकार', gu: 'સિંચાઈનો પ્રકાર' },
  'farmProfile.save': { en: 'Save Profile', hi: 'प्रोफ़ाइल सहेजें', gu: 'પ્રોફાઇલ સાચવો' }
};